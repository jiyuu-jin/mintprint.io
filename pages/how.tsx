  ...
  return (
    <div>
      ...
      <ul style={{maxWidth: "500px", margin: "50px auto 0 auto", fontSize: "25px", listStyle: "none"}}>
        ...
        <li style={{padding: "10px"}}><span style={{fontWeight: "bold"}} >Step 5:</span> Supporters of the creator are able to click the link and claim a token from the supply.</li>
      </ul>
    </div>
  )
};
